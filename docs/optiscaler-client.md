...
Download [OptiScaler Client 1.0.7-bc250.5 for Linux x64](https://github.com/daniel-h-0/bc250-fsr4-fork/releases/download/opticlient-v1.0.7-bc250.5/bc250-opticlient-1.0.7-bc250.5-linux-x64.tar.gz),
