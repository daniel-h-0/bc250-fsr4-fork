...
ORDER = ["fsr411", "fsr411b", "v3", "v4r9"]
COLORS = {"fsr411": "#C0C7D2", "fsr411b": "#819ED0", "v3": "#A395DC", "v4r9": "#5DE2B5"}
LABELS = {
...
def render():
    ...
    plt.rcParams.update(
        {
            ...
            "svg.hashsalt": "bc250-fsr4-four-way-cost-20260911-rc9",
        }
    )
    ...
    for group, (resolution, dimensions) in enumerate(config["sizes"].items()):
        ...
        for index, variant in enumerate(ORDER):
            ...
            label = ax.text(
                ...
                ha="center",
                va="bottom",
                color=COLORS[variant] if variant == "v4r9" else INK,
                fontsize=14.5,
                fontproperties=bold,
            )
    ...
    fig.text(
        0.073,
        0.049,
        "RC9: 11 Sep 2026 · baselines unchanged: 10 Sep 2026 · v3 uses its original Mesa; others share standard Mesa.",
        color=MUTED,
        fontsize=10.0,
        fontproperties=font,
        va="center",
    ...
    stem = ASSETS / "fsr4-four-way-gpu-cost-rc9"
