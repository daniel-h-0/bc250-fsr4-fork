...
driver and Proton. No custom driver, shared folder or cache helper is required.
...
environment variable; `false`/`0` still enables the banner in the pinned adapter.
...
Native Windows does not use these Proton options.
